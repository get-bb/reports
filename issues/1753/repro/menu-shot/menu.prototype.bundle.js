...
// src/menu.prototype.ts
var menu_prototype_exports = {};
__export(menu_prototype_exports, {
...
module.exports = __toCommonJS(menu_prototype_exports);
...
function createServerMenuItems(args) {
  ...
  const note = args.serversNote === void 0 || args.serversNote === null ? [] : [{ enabled: false, label: args.serversNote }];
  return [
    ...serverItems,
    ...note,
    { type: "separator" },
