...
await page.waitForTimeout(1500);
await saveScreenshot(await page.screenshot(), "1776-verify-04-existing-draft.png");
...
await saveScreenshot(await page.screenshot(), "1776-verify-05-after-click-existing-draft.png");
