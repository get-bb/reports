...
await saveScreenshot(await page.screenshot(), "1440-verify-before.png");
...
await saveScreenshot(await page.screenshot(), "1440-verify-select-all.png");
...
await saveScreenshot(await page.screenshot(), "1440-verify-drag-sidebar.png");
