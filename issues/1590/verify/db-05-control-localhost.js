...
await page.goto(
  "http://localhost:13934/projects/proj_67cuq4v8fc/threads/thr_3q88fks8ry",
...
console.log(
  await saveScreenshot(await page.screenshot(), "1590-verify-localhost-after-copy.png"),
);
