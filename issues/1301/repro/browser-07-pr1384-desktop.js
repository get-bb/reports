...
for (let i = 1; i <= 60; i++) {
  ...
  if (!tookMid && s.rows > 300) { tookMid = true; console.log(await saveScreenshot(await page.screenshot(), "1301-pr1384-desktop-mid.png")); }
...
console.log(await saveScreenshot(await page.screenshot(), "1301-pr1384-desktop-top.png"));
