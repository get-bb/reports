...
const [startSub, ...targets] = process.argv.slice(2);
if (targets.length === 0) {
...
const startId = [...graph.keys()].find((id) => id.includes(startSub)) ?? entryId; const parent = new Map([[startId, null]]);
const queue = [startId];
