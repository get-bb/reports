...
const URL = "http://localhost:13007/projects/proj_fhjcps9e4e/threads/thr_dbwc8u9p36";
...
await page.screenshot({ path: "/tmp/bb-reports/issues/1837/verify/loading.png" });

release();
await page.waitForSelector("iframe[title^='inline-vis']", { timeout: 30000 });
await new Promise((r) => setTimeout(r, 1500));
const after = await measure();
await page.screenshot({ path: "/tmp/bb-reports/issues/1837/verify/loaded.png" });
