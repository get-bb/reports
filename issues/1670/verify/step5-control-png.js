...
const result = await page.evaluate(async () => {
  const url =
    "http://localhost:24802/api/v1/projects/proj_hugfb39efv/attachments/content?path=sample-decoded-small-1787063165546-cytvda.png";
...
await saveScreenshot(await page.screenshot(), "1670-verify-control-png.png");
