...
await page.goto("http://localhost:16802/projects/proj_hugfb39efv", { waitUntil: "networkidle" });
await page.waitForTimeout(2500);
const editor = page.locator('[contenteditable="true"]').first();
await editor.click({ timeout: 5000 });
await saveScreenshot(await page.screenshot(), "1670-verify-before.png");
...
await saveScreenshot(await page.screenshot(), "1670-verify-composer-broken.png");
