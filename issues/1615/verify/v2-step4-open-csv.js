...
console.log(await saveScreenshot(await page.screenshot(), "1615-v2-csv-search.png"));
...
console.log(await saveScreenshot(await page.screenshot(), "1615-v2-csv-preview.png"));
