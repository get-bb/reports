...
console.log(await saveScreenshot(await page.screenshot(), "1615-verify-banner-collapsed.png"));
const t0 = Date.now();
await toggle.click();
...
console.log(await saveScreenshot(await page.screenshot(), "1615-verify-banner-expanded.png"));
