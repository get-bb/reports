// dev-browser script: open the New project dialog, browse to /home/sawyer/.bb-dev/1615-qa-v2/manyfiles
// (5000 files) in RemotePathBrowser and count the rows in the h-56 scroll box.
const page = await browser.getPage("p6");
await page.setViewportSize({ width: 1400, height: 900 });
await page.goto("http://localhost:14231/", { waitUntil: "load" });
await page.waitForTimeout(2000);
await page.getByRole("button", { name: "New project", exact: true }).click({ force: true });
await page.waitForTimeout(1200);
console.log(await saveScreenshot(await page.screenshot(), "1615-v2-newproject.png"));
...
if (await input.count()) {
  await input.fill("/home/sawyer/.bb-dev/1615-qa-v2/manyfiles");
  ...
  console.log(await saveScreenshot(await page.screenshot(), "1615-v2-path-browser.png"));
}
