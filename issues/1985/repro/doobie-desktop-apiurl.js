...
await page.evaluate(() => {
  ...
  f.id = "qa-pdf-frame";
  f.src = "/api/v1/projects/proj_cw26yy9qhd/files/content?path=handbook.pdf";
...
await page.screenshot({ path: "/tmp/bb-reports/issues/assets/1985-desktop-pr1979-apiurl.png" });
